import { Injectable, NotAcceptableException, PipeTransform, SetMetadata } from '@nestjs/common';
...
@Injectable()
export class SharpPipe implements PipeTransform<UploadeFileMulter, Promise<UploadeFileMulter | null>> {

    async transform(files: UploadeFileMulter): Promise<UploadeFileMulter | null> {
        ...
        try {
            ...
            console.log(err);
            throw new NotAcceptableException(Error, 'Nieznany błąd serwera');
        }
    };
}
